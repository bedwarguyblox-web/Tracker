    ...
    <div>
      <div className="flex items-center justify-between gap-3 mb-5">
        <div>
          ...
          <p className="text-sm text-folder-500 dark:text-folder-400">
            Join a section with a code, or create one for your class.
          </p>
        </div>
        <div className="flex gap-2 shrink-0">
          ...
          {canCreate && (
            <button
              ...
              className="rounded-full px-4 py-2 text-sm bg-folder-700 text-white hover:bg-folder-800"
            >
              Create
            </button>
          )}
      ...
      {loading ? (
        ...
        <div className="rounded-card border border-dashed border-folder-200 dark:border-folder-700 py-14 text-center text-folder-500">
          ...
          <p className="text-sm mt-1">Join one with a code, or create your own.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {sections.map((s, i) => (
            ...
            >
              ...
              <p className="text-xs font-mono text-folder-500 dark:text-folder-400 mt-1">
                Code: {s.join_code}
              </p>
